...
const PROJECTS = [
  ...
  {
    id: "h-34-b",
    title: "Хозблок Х-34-Б",
    size: "3 × 4 м",
    description: "Каркасный хозблок на столбчатом фундаменте. Пол по лагам, отделка ОСП внутри, профлист и имитация бруса снаружи.",
    specs: [
      { label: "Наружные габариты", value: "3 × 4 м" },
      { label: "Внутренние габариты", value: "2,8 × 3,8 м" },
      { label: "Высота потолка", value: "2,2 – 2,7 м" },
    ...
    aiPhotos: [
      "https://cdn.poehali.dev/projects/6409a538-d873-4bb0-ab67-be0ca95ae39e/files/991cd499-2e9a-4f0e-9765-282c4faad071.jpg",
    ],
  },
  {
    id: "hb-27-40",
    title: "Хозблок ХБ-27-40",
    size: "2,7 × 4 м",
    description: "Компактный каркасный хозблок на столбчатом фундаменте. Пол по лагам, ОСП внутри, профлист и имитация бруса снаружи.",
    specs: [
      { label: "Наружные габариты", value: "2,7 × 4 м" },
      { label: "Внутренние габариты", value: "2,5 × 3,8 м" },
      { label: "Высота потолка", value: "2,1 – 2,25 м" },
      { label: "Высота от земли", value: "3 м" },
      { label: "Фундамент", value: "Столбчатый из бетонных блоков" },
      { label: "Пол", value: "По лагам из доски 50×150 мм" },
      { label: "Каркас стен", value: "Доска 50×100 мм" },
      { label: "Стропила", value: "Доска 50×150 мм" },
    ...
    aiPhotos: [
      "https://cdn.poehali.dev/projects/6409a538-d873-4bb0-ab67-be0ca95ae39e/files/27de1446-f04b-40bc-9739-83a45a8bbd3f.jpg",
    ],
  },
  {
    id: "k-35",
    title: "Хозблок К-35",
    size: "3 × 5 м",
    description: "Каркасный хозблок с кровлей из битумной черепицы и отделкой имитацией бруса снаружи. Вагонка внутри. На столбчатом фундаменте из бетонных блоков.",
    specs: [
      { label: "Наружные габариты", value: "3 × 5 м" },
      { label: "Внутренние габариты", value: "2,8 × 4,8 м" },
      { label: "Высота потолка", value: "2,2 – 2,65 м" },
      { label: "Высота от земли", value: "3 м" },
      { label: "Фундамент", value: "Столбчатый из бетонных блоков" },
      { label: "Пол", value: "По лагам из доски 50×150 мм" },
      { label: "Каркас стен", value: "Доска 50×100 мм" },
      ...
      { label: "Отделка снаружи", value: "Битумная черепица + имитация бруса" },
      { label: "Кровля", value: "Битумная черепица" },
    ],
    aiPhotos: [
      "https://cdn.poehali.dev/projects/6409a538-d873-4bb0-ab67-be0ca95ae39e/files/e83b5193-d5f2-4843-a855-66635d525a18.jpg",
    ],
  },
];
